(function ( $, x5engine ) {
	...
	s.siteId = '33CB086BCDC4A8A3F142E61F80A0E7F5';
	s.islocal = true;
	$.extend(true, s , {
		"imCart": {
			"localProductsData": {}
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: '3', path: 'captcha/imcpa_p4x.gif'},
				"1": { letter: 'A', path: 'captcha/imcpa_sz5.gif'},
				"2": { letter: 'H', path: 'captcha/imcpa_l2l.gif'},
				"3": { letter: 'P', path: 'captcha/imcpa_tre.gif'},
				"4": { letter: 'H', path: 'captcha/imcpa_nfr.gif'},
				"5": { letter: 'L', path: 'captcha/imcpa_tu4.gif'},
				"6": { letter: 'D', path: 'captcha/imcpa_vg3.gif'},
				"7": { letter: 'X', path: 'captcha/imcpa_un3.gif'},
				"8": { letter: 'V', path: 'captcha/imcpa_s5v.gif'},
				"9": { letter: 'V', path: 'captcha/imcpa_awg.gif'}
			}
		});
	}, false, 'first');
